...
angular.module('storeApp.services',['ngResource'])
//.constant("baseURL", "http://localhost:3000/")
.constant("baseURL", "http://192.168.1.7:3000/")
    .factory('productFactory', ['$resource', 'baseURL', function($resource,baseURL){


        return $resource(baseURL + "products/:id", null, {
            'update': {
                method: 'PUT'
            }
        });
    ...
    .factory('commentFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "products/:id/comments/:commentId", { id: "@Id", commentId: "@CommentId" }, {
            'update': {
                method: 'PUT'
            }
        });
    ...
    .factory('reviewFactory', ['$resource', 'baseURL', function ($resource, baseURL) {
        ...
        return $resource(baseURL + "offers/:id/reviews/:reviewId", { id: "@Id", reviewId: "@ReviewId" }, {
            'update': {
                method: 'PUT'
            }
        });
...
.factory('offersFactory', ['$resource', 'baseURL', function($resource,baseURL){


           return  $resource(baseURL+"offers/:id",null,{
               'update':{
                   method:'PUT' }
           });
